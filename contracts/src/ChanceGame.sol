...
contract ChanceGame is ERC1155, ReentrancyGuard {
    ...
    /// @dev One request per batch, with no cancellation or replacement. Failed requests
    /// revert atomically; a successful request needs the pinned provider to deliver.
